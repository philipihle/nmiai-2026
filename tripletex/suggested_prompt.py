...
- 1500 (AR), 1920 (bank), 2400 (AP) — managed by invoice module
...
- 6000-6999: Rent, utilities, marketing, office (NOT 6860 in some setups)
...
For manual vouchers, the 'customer' and 'supplier' fields on postings should NOT be used, as the associated accounts (1500, 2400) are system-managed and will cause the voucher creation to fail.
