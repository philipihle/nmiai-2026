...
TOOLS = [
    ...
    },
    {
        "name": "create_project",
        "description": (
            "Create a new project. Required: name, startDate, projectManager. "
            "projectManager is REQUIRED by Tripletex — always search_employees first to find the manager ID. "
            "Common optional fields: customer ({id}), endDate, description, number (project number), mainProject ({id})."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
            ...
            "required": ["name", "startDate", "projectManager"],
        },
    },
    {
