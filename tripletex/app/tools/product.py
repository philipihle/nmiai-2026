...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "IMPORTANT: You MUST call get_vat_types FIRST to get valid vatType IDs — never guess or hardcode! "
            "Common fields: number (SKU), costExcludingVatCurrency, "
            "priceExcludingVatCurrency, priceIncludingVatCurrency, vatType ({id}), productUnit ({id})."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                ...
                "productUnit": {"type": "object", "properties": {"id": {"type": "integer"}}},
            },
            "required": ["name"],
        },
    },
