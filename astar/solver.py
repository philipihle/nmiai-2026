...
# 14 calibration points from per-round tuning (R1-R16, excluding R7 outlier and R12 pending)
# Sorted by settle_rate. Generated by tune_per_round.py on 2026-03-21.
_CALIBRATION_POINTS = [
    {"rate": 0.002, "round": 3, "params": {
        "death_base_rate": 0.150,
        "death_food_factor": 0.150,
        "food_base_regen": 0.150,
        "food_competition": 0.050,
        "food_forest_bonus": 0.020,
        "food_pop_drain": 0.080,
        "pop_growth_rate": 0.080,
        "port_prob": 0.100,
        "port_survival_bonus": 0.030,
        "spawn_pop_threshold": 0.300,
        "spawn_prob": 0.150,
    }},
    {"rate": 0.009, "round": 10, "params": {
        "death_base_rate": 0.080,
        "death_food_factor": 0.150,
        "food_base_regen": 0.150,
        "food_competition": 0.050,
        "food_forest_bonus": 0.040,
        "food_pop_drain": 0.040,
        "pop_growth_rate": 0.100,
        "port_prob": 0.100,
        "port_survival_bonus": 0.000,
        "spawn_pop_threshold": 0.700,
        "spawn_prob": 0.150,
    }},
    {"rate": 0.011, "round": 19, "params": {
        "death_base_rate": 0.100,
        "death_food_factor": 0.100,
        "food_base_regen": 0.100,
    ...
    {"rate": 0.023, "round": 8, "params": {
        "death_base_rate": 0.100,
        "death_food_factor": 0.100,
        "food_base_regen": 0.150,
        "food_competition": 0.030,
        "food_forest_bonus": 0.040,
        "food_pop_drain": 0.040,
        "pop_growth_rate": 0.100,
        "port_prob": 0.100,
    ...
    {"rate": 0.039, "round": 20, "params": {
        "death_base_rate": 0.060,
        "death_food_factor": 0.200,
        "food_base_regen": 0.250,
        "food_competition": 0.070,
        "food_forest_bonus": 0.040,
        "food_pop_drain": 0.040,
        "pop_growth_rate": 0.080,
    ...
    {"rate": 0.061, "round": 21, "params": {
        "death_base_rate": 0.020,
        "death_food_factor": 0.060,
        "food_base_regen": 0.120,
        "food_competition": 0.050,
        "food_forest_bonus": 0.010,
        "food_pop_drain": 0.100,
        "pop_growth_rate": 0.100,
        "port_prob": 0.120,
        "port_survival_bonus": 0.010,
        "spawn_pop_threshold": 0.300,
        "spawn_prob": 0.080,
    }},
    {"rate": 0.076, "round": 16, "params": {
        "death_base_rate": 0.003,
        "death_food_factor": 0.060,
        "food_base_regen": 0.150,
        "food_competition": 0.040,
        "food_forest_bonus": 0.020,
        "food_pop_drain": 0.080,
        "pop_growth_rate": 0.060,
        "port_prob": 0.120,
        "port_survival_bonus": 0.010,
        "spawn_pop_threshold": 0.700,
        "spawn_prob": 0.120,
    }},
    {"rate": 0.086, "round": 4, "params": {
        "death_base_rate": 0.030,
        "death_food_factor": 0.060,
        "food_base_regen": 0.150,
        "food_competition": 0.030,
        "food_forest_bonus": 0.040,
        "food_pop_drain": 0.060,
        "pop_growth_rate": 0.120,
        "port_prob": 0.100,
        "port_survival_bonus": 0.000,
        "spawn_pop_threshold": 0.300,
        "spawn_prob": 0.080,
    }},
    {"rate": 0.091, "round": 13, "params": {
        "death_base_rate": 0.030,
        "death_food_factor": 0.060,
        "food_base_regen": 0.150,
        "food_competition": 0.020,
        "food_forest_bonus": 0.060,
        "food_pop_drain": 0.060,
        "pop_growth_rate": 0.100,
        "port_prob": 0.100,
        "port_survival_bonus": 0.000,
    ...
    {"rate": 0.119, "round": 5, "params": {
        "death_base_rate": 0.010,
        "death_food_factor": 0.040,
        "food_base_regen": 0.180,
        "food_competition": 0.030,
        "food_forest_bonus": 0.060,
        "food_pop_drain": 0.100,
        "pop_growth_rate": 0.060,
        "port_prob": 0.080,
        "port_survival_bonus": 0.020,
        "spawn_pop_threshold": 0.700,
        "spawn_prob": 0.120,
    }},
    {"rate": 0.128, "round": 9, "params": {
        "death_base_rate": 0.020,
        "death_food_factor": 0.060,
        "food_base_regen": 0.200,
        "food_competition": 0.030,
        "food_forest_bonus": 0.040,
        "food_pop_drain": 0.080,
        "pop_growth_rate": 0.120,
        "port_prob": 0.100,
        "port_survival_bonus": 0.000,
        "spawn_pop_threshold": 0.500,
        "spawn_prob": 0.100,
    }},
    {"rate": 0.152, "round": 1, "params": {
        "death_base_rate": 0.020,
        "death_food_factor": 0.010,
        "food_base_regen": 0.300,
        "food_competition": 0.050,
        "food_forest_bonus": 0.020,
        "food_pop_drain": 0.040,
        "pop_growth_rate": 0.100,
        "port_prob": 0.100,
        "port_survival_bonus": 0.030,
        "spawn_pop_threshold": 0.400,
        "spawn_prob": 0.080,
    }},
    {"rate": 0.164, "round": 15, "params": {
        "death_base_rate": 0.020,
        "death_food_factor": 0.030,
        "food_base_regen": 0.250,
        "food_competition": 0.050,
        "food_forest_bonus": 0.020,
        "food_pop_drain": 0.040,
    ...
    {"rate": 0.181, "round": 2, "params": {
        "death_base_rate": 0.015,
        "death_food_factor": 0.030,
        "food_base_regen": 0.150,
        "food_competition": 0.040,
        "food_forest_bonus": 0.060,
    ...
    {"rate": 0.230, "round": 6, "params": {
        "death_base_rate": 0.008,
        "death_food_factor": 0.040,
        "food_base_regen": 0.300,
        "food_competition": 0.040,
        "food_forest_bonus": 0.080,
        "food_pop_drain": 0.060,
        "pop_growth_rate": 0.140,
        "port_prob": 0.100,
        "port_survival_bonus": 0.010,
        "spawn_pop_threshold": 0.300,
        "spawn_prob": 0.100,
    }},
    {"rate": 0.239, "round": 14, "params": {
        "death_base_rate": 0.003,
        "death_food_factor": 0.010,
        "food_base_regen": 0.400,
        "food_competition": 0.010,
        "food_forest_bonus": 0.080,
        "food_pop_drain": 0.060,
        "pop_growth_rate": 0.100,
        "port_prob": 0.080,
    ...
    {"rate": 0.250, "round": 11, "params": {
        "death_base_rate": 0.005,
        "death_food_factor": 0.010,
        "food_base_regen": 0.350,
        "food_competition": 0.005,
        "food_forest_bonus": 0.040,
        "food_pop_drain": 0.060,
        "pop_growth_rate": 0.100,
        "port_prob": 0.080,
    ...
    {"rate": 0.250, "round": 17, "params": {
        "death_base_rate": 0.020,
        "death_food_factor": 0.020,
        "food_base_regen": 0.300,
        "food_competition": 0.010,
        "food_forest_bonus": 0.100,
        "food_pop_drain": 0.030,
        "pop_growth_rate": 0.120,
        "port_prob": 0.120,
        "port_survival_bonus": 0.000,
        "spawn_pop_threshold": 0.500,
    ...
    {"rate": 0.331, "round": 18, "params": {
        "death_base_rate": 0.002,
        "death_food_factor": 0.010,
        "food_base_regen": 0.500,
        "food_competition": 0.015,
        "food_forest_bonus": 0.100,
        "food_pop_drain": 0.060,
        "pop_growth_rate": 0.200,
        "port_prob": 0.150,
        "port_survival_bonus": 0.000,
        "spawn_pop_threshold": 0.300,
        "spawn_prob": 0.100,
...
def params_from_rate(settle_rate):
    ...
    for i in range(len(rates) - 1):
        if rates[i] <= settle_rate <= rates[i + 1]:
            ...
            blended = {}
            for k in lo["params"]:
                val = lo["params"][k] * (1 - t) + hi["params"][k] * t
                # Integer params must stay integer
                if isinstance(lo["params"][k], int) and isinstance(hi["params"][k], int):
                    val = int(round(val))
                blended[k] = val
...
class AstarSolver:
    ...
    @property
    def _ml_weight(self):
        rate = getattr(self, "_observed_settle_rate", 0)
        if rate > 0.30:
            return 0.0  # Very high growth: MC is much better, disable ML
    ...
    def _mc_weight(self):
        rate = getattr(self, "_observed_settle_rate", 0)
        if rate > 0.30:
            base = 0.90  # Very high growth: trust MC simulation more
        elif self.round_type == "normal":
            base = 0.40
        else:
            base = 0.60
    ...
    def _prior_weight(self):
        rate = getattr(self, "_observed_settle_rate", 0)
        if rate > 0.30:
            base = 0.10  # Very high growth: reduce prior influence
            mc_nominal = 0.90
        elif self.round_type == "normal":
            base = 0.30
            mc_nominal = 0.40
        ...
        mc_lost = mc_nominal * (1.0 - getattr(self, "_mc_weight_adjustment", 1.0))
        return base + mc_lost
    ...
    REPEAT_QUERIES_PER_SEED = 6  # repeated viewport sampling per seed (was 3)
    ...
    def solve_round(self, round_id: Optional[str] = None) -> dict:
        ...
        for si in range(n_seeds):
            ...
            if mc_pred is not None and si == 0:
                mc_settle_rate = float(mc_pred[:, :, 1].mean() + mc_pred[:, :, 2].mean())
        ...
        # Allocate 2/3 of remaining budget to repeats (was 1/3)
        # More repeats = less observation bias = better empirical distributions
        repeat_budget = min(remaining * 2 // 3, self.REPEAT_QUERIES_PER_SEED * n_seeds)
